-- Press Conference V2 — persistent, deterministic press-conference engine.
-- Feature-flagged OFF at runtime; these tables are additive and leave the
-- legacy press_conference table untouched.
