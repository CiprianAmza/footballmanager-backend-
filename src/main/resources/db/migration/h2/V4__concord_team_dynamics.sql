-- CONCORD Team Dynamics (feature flag dynamics.enabled, default OFF).
-- Monthly team meeting, contextual player conversations and their promises.
-- Tables are inert until the flag is enabled.
...
CREATE TABLE IF NOT EXISTS team_meeting (
    ...
    manager_reputation DOUBLE DEFAULT 0 NOT NULL,
    participant_count INTEGER DEFAULT 0 NOT NULL,
    average_morale_delta DOUBLE DEFAULT 0 NOT NULL,
...
CREATE TABLE IF NOT EXISTS team_meeting_reaction (
    ...
    morale_before DOUBLE DEFAULT 0 NOT NULL,
    morale_delta DOUBLE DEFAULT 0 NOT NULL,
    reason VARCHAR(500)
);
